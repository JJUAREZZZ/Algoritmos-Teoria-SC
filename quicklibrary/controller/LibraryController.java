...
public class LibraryController {
    ...
    private void guardarLibros() {
        ...
        try {
            escritor = new BufferedWriter(new FileWriter(archivoLibros));
            escritor.write("codigo,titulo,autor,categoria,anio,estado\n");
            CustomLinkedList<Book> libros = obtenerTodosLibros();
            int i;
    ...
    private void guardarSolicitudes() {
        BufferedWriter escritor = null;
        try {
            escritor = new BufferedWriter(new FileWriter(archivoSolicitudes));
            escritor.write("codigoEstudiante,nombreEstudiante,codigoLibro,fechaSolicitud\n");
            CustomLinkedList<LoanRequest> solicitudes = obtenerSolicitudesPendientes();
            int i;
    ...
    private void guardarHistorial() {
        BufferedWriter escritor = null;
        try {
            escritor = new BufferedWriter(new FileWriter(archivoHistorial));
            escritor.write("codigoEstudiante,nombreEstudiante,codigoLibro,tituloLibro,fechaSolicitud,fechaAtencion,resultado\n");
            CustomLinkedList<LoanRecord> historial = obtenerHistorialPrestamos();
            int i;
