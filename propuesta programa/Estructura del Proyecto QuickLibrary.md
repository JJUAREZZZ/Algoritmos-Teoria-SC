# **Estructura del Proyecto: QuickLibrary**

Este documento detalla la organización modular del sistema, diseñada para ser eficiente, escalable y fácil de mantener.
...
└── com/quicklibrary/  
    ...
    │   └── DataHandler.java     // (Opcional) Lógica para cargar datos desde un CSV  
    └── utils/  
...
* **models/ (Datos)**  
  * Libro.java: Representa el objeto libro. Debe implementar la interfaz Comparable\<Libro\> para que el árbol pueda ordenar y buscar los libros mediante su código.  
* **structures/ (El motor del proyecto)**  
  * Queue.java: Estructura de datos lineal (cola) implementada con nodos enlazados. Debe usar tipos genéricos \<T\>.  
...
## **3\. ¿Por qué esta estructura es eficiente?**
